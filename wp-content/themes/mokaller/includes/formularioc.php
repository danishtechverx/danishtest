<div class="formulario">
	...
	<form id="form" name="form" method="post" action="javascript:validarForm();">
		...
		<input type="hidden" id="landing_name" name="landing_name" value="<?php echo the_title(); ?>" />
		<input type="hidden" id="destination" name="destination" value="<?php echo $fdestination; ?>" />
		<div class="p1">
			<?php 
			$args=array(
				'post_type'=>'form',
