...
<?php if ( $settings['show_date'] ) { ?>
	<li>
		<i class="fa fa-calendar"></i><a href="<?php the_permalink(); ?>"><time datetime="<?php the_time('Y-m-d') ?>" itemprop="datePublished"><?php echo get_the_date(); ?></time></a>
		<meta itemprop="dateModified" content="<?php the_modified_time('Y-m-d'); ?>">
	</li>
<?php } ?>
<?php if ( $authorId ) { ?>
	<li><i class="fa fa-user"></i><a href="<?php echo esc_url( get_author_posts_url( $authorId ) ) ?>"><span itemprop="author" itemscope itemtype="http://schema.org/Person"><span itemprop="name"><?php echo get_the_author(); ?></span></span></a></li>
<?php } ?>
